CLASS znumberrageget DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZNUMBERRAGEGET IMPLEMENTATION.
...
method if_oo_adt_classrun~main.
  ...
  nr_attribute-buffer = ' '.
  nr_attribute-object = 'ZGENPO'." // object name
...
* st_INTERVAL-toyear
  st_interval-fromnumber  = '9000000'. "// starting number
...
data number type cl_numberrange_runtime=>nr_number..
 TRY.
      cl_numberrange_runtime=>number_get(  EXPORTING nr_range_nr = '01' object = 'ZGENPO' "quantity    = 0001
